        ...
        <div class="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex gap-6 text-sm font-bold text-slate-600">
                ...
                <c:choose>
                    ...
                    <c:when test="${sessionScope.userRole == 'owner'}"><a href="paymentController" class="border-b-2 border-transparent hover:text-orange-500href="receipts.jsp" transition-colors pb-1">Revenue</a></c:when>
                </c:choose>
            </div>
    ...
    <div id="profileDrawer" class="fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-[101] transform translate-x-full transition-transform duration-300 ease-in-out flex flex-col border-l border-slate-100">
        ...
        <div class="p-4 flex-1 flex flex-col gap-2 overflow-y-auto">
            ...
            <c:if test="${sessionScope.userRole == 'owner'}">
                <a href="properties" class="nav-link flex items-center gap-3 p-3 rounded-xl hover:bg-slate-100 text-slate-700 hover:text-slate-900 font-bold transition-all group">
